...
public class Player implements MediaPlayer.OnCompletionListener {
    ...
    public void realize() throws IllegalStateException, IOException, SecurityException, IllegalArgumentException, MediaException {
        if (this.state < 200) {
            try {
    ...
    public void prefetch() throws IllegalStateException, IOException, SecurityException, IllegalArgumentException, MediaException {
        if (this.state < 300) {
            if (this.state < 200) {
                realize();
            }
    ...
    public void start() throws IllegalStateException, IOException, SecurityException, IllegalArgumentException, MediaException {
        if (this.state < 400) {
            if (this.state < 200) {
                realize();
            }
    ...
    public void setLoopCount(int count) throws IllegalStateException, IllegalArgumentException {
        if (this.state == 400) {
