...
public class Map implements Key_H {
    ...
    public void createLayer() throws IOException {
        createMap();
        setMapData();
    }
    ...
    public void goNextMap() throws IOException {
        setfmap();
    ...
    public void eventCheck() throws IOException {
        boolean bt;
    ...
    private void runEvent_getMon(int i) throws IOException {
        this.gmErr = false;
    ...
    private void runEvent_srcMove(int i) {
        ...
        int iMap_set = map_set(x, this.cols, Constants_H.XCELLS, Constants_H.HALF_XCELLS, Constants_H.WIDTH, 20);
        int x3 = this.map_x;
        int x4 = iMap_set - x3;
    ...
    private void runEvent_goShop(int i) throws IOException {
    ...
    private void runEvent_item_add_del(int i) {
        ...
        if (this.eventGoing == 0) {
            ...
            if (this.event[i][this.event_now[i] + 3] >= 0) {
                ...
                byte bFindItem = this.gr.findItem(-2, this.now_eV1, true);
                Ms.i();
                if (bFindItem >= Ms.abs(this.now_eV2)) {
                    GameRun gameRun = this.gr;
                    byte b = this.now_eV1;
                    Ms.i();
            ...
            if (event_temp != -1) {
                ...
                StringBuilder sbAppend = new StringBuilder(String.valueOf(this.now_eV2 >= 0 ? Constants_H.MONEY_TXT_7 : Constants_H.MONEY_TXT_13)).append(this.gr.getNameItem(this.now_eV1)).append("x");
                Ms.i();
                gameRun2.say(sbAppend.append(Ms.abs(this.now_eV2)).toString(), 0);
            }
            this.eventGoing = (byte) 1;
            return;
        }
    ...
    */
    public void drawBlackSRC(Graphics g2, int y, boolean mode) {
        int WIDTH = Constants_H.WIDTH__;
        int HEIGHT = Constants_H.HEIGHT__;
        int WIDTH_H = Constants_H.WIDTH__ / 2;
        g2.setColor(16777215);
        short d = 0;
        short offy = (byte) (this.black_0 - 5 > 0 ? this.black_0 - 5 : 0);
        if (this.gr.about_d != null) {
            while (true) {
                if (!mode) {
                    ...
                    if (mode) {
                        if (this.black_0 == d) {
                            int i = 25 + 4;
                            g2.setClip(0, ((d - offy) * 29) + y, this.black_1 << 1, 25 + 4);
                        }
                        int i2 = 25 + 4;
                        Ui.i().drawStringColor(this.gr.about_d[d].toString(), 25, ((d - offy) * 29) + y, 0, 0);
            ...
            if (this.black_0 == this.gr.about_d.length) {
                this.gr.drawZero(WIDTH_H, (HEIGHT - 25) - 4, 1 | 32, 0);
                return;
            }
            if (!mode) {
    ...
    public void doKey() throws IOException {
        switch (this.map_key) {
            case -57:
                Ms.i().keyRelease();
    ...
    public void goMiniMap() throws IOException {
        Ms.i().keyRelease();
    ...
    private void initMissionList() throws IOException {
    ...
    private void drawMisstionList(int x, int y, int w, int sh, int show_num, byte[] sel, int length) {
        ...
        while (i3 < sel[1] + show_num) {
            if (i3 < length) {
                ...
                Ui uiI = Ui.i();
                int i4 = x + 8;
                int i5 = ((i3 - sel[1]) * (sh - 1)) + y;
                if (i3 < this.bMission[14]) {
                    i = -1;
                } else {
                    i = sel[0] == i3 ? 0 : 3;
                }
                uiI.drawString(s, i4, i5, 0, i, 0);
                if (this.gr.cur_a == 0 && i3 != length - 1) {
                    Ui uiI2 = Ui.i();
                    int i6 = (x + w) - 8;
                    int i7 = y + ((i3 - sel[1]) * (sh - 1));
                    if (i3 < this.bMission[14]) {
                        i2 = -1;
                    } else {
                        i2 = sel[0] == i3 ? 0 : 3;
                    }
                    uiI2.drawString(Constants_H.MISSION_TXT_6, i6, i7, 24, i2, 0);
                }
    ...
    private void loadMapModuleAndImage() throws IOException {
        Ms.i();
        Ms.skip = 0;
    ...
    private void loadMapData(int id) throws IOException {
            ...
            if (id >= -1) {
                ...
                if ((cur_npc.other[4] == 1 || cur_npc.other[4] == 2) && ((cur_npc.brow_type > -1 || cur_npc.other[6] != 0) && (id <= -1 || isNpcSrc(cur_npc.x, cur_npc.y)))) {
                    ...
                    if (cur_npc.brow_action >= this.brow.aLength(cur_npc.brow_type)) {
                        ...
                        Ui.i().drawFrameOne(this.brow, this.brow.action(cur_npc.brow_type, cur_npc.brow_action, 0), this.map_x + cur_npc.x + 14, ((this.map_y + cur_npc.y) - 15) - 10, 0);
                        Npc npc2 = cur_npc;
                        b = (byte) (npc2.brow_time + 1);
                        npc2.brow_time = b;
                        if (b <= this.brow.action(cur_npc.brow_type, cur_npc.brow_action, 1)) {
                            Npc npc3 = cur_npc;
                            npc3.brow_action = (byte) (npc3.brow_action + 1);
                            cur_npc.brow_time = (byte) 0;
                        }
                    }
                }
    ...
    */
    ...
    private void drawSrcEffect() {
        ...
        if (this.my.state == 22) {
            ...
            if (this.eventGoing == 2) {
                int i = 25 + 4;
                length = (HEIGHT - (this.gr.about_d.length * 29)) >> 1;
            } else {
                length = 45;
            }
            drawBlackSRC(graphics, length, this.eventGoing == 2);
        }
    }
