...
public class GameRun extends GameRun_F {
    ...
    public void run_gameRun() throws IOException {
        switch (run_state) {
            case -86:
            case -15:
                if (this.b_c == 0) {
                    ...
                    if (this.cMon_count == this.max_monsters && this.myMon_length == this.max_takes) {
                        ...
                        if (Ms.getRandom(100) < getRate) {
                            ...
                            if (this.myB.getMon().isMonReel(41) || this.enB.getMon().isEffect(4) || this.enB.getMon().isEffect(3)) {
                                ...
                                StringBuilder sbAppend = new StringBuilder("#n").append(getNameMon(this.enB.getMon().monster[0]));
                                Ms.i();
                                str.append(sbAppend.append(s[Ms.getRandom(3)]).toString());
                            }
                            say(str.toString(), 0);
                            break;
                        }
    ...
    public void paint_gameRun(Graphics g) throws IOException {
        switch (run_state) {
            case -50:
                drawBattleBG();
    ...
    private void drawEffectImage(Monster monster, int x, int y) {
        if (monster.effect > -1 && monster.effect < 7 && monster.effect_time > 0) {
            ...
            uiI.drawImage(image, x, y, 8 | 32);
            Ui uiI2 = Ui.i();
            String string = new StringBuilder().append((int) monster.effect_time).toString();
            Graphics graphics3 = g;
            Graphics graphics4 = g;
            uiI2.drawNum(string, x, y, 8 | 32, 0);
        }
    }
    ...
    public void goBUY_ITEM(int id, int mode) throws IOException {
        if (mode != 1) {
    ...
    public void drawMoney(int x, int y, int c, boolean bb) {
        ...
        Graphics graphics = g;
        Graphics graphics2 = g;
        uiI.drawUi(i, stringWidth, y, 8 | 32, 0);
        Graphics graphics3 = g;
        Graphics graphics4 = g;
        ...
        while (i < sel[1] + show_num) {
            if (i < length) {
                if (mode == 0 || mode == 2) {
                    ...
                    Ui uiI = Ui.i();
                    int i2 = (x + w) - 12;
                    int i3 = y + 1 + ((i - sel[1]) * 30);
                    Graphics graphics = g;
                    Graphics graphics2 = g;
                    uiI.drawString(str, i2, i3, 8 | 16, sel[0] == i ? 0 : 3, 0);
                } else {
                    ...
                    int i4 = ((i - sel[1]) * 30) + y + 1;
                    Graphics graphics3 = g;
                    Graphics graphics4 = g;
                    Ui.i().drawString(String.valueOf((int) getPrice(itemType, i, true)) + str2, (x + w) - 12, i4, 8 | 16, color, 0);
                }
    ...
    private void popBagState() throws IOException {
        if (Ms.i().key_Up_Down()) {
                ...
                switch (id) {
                    ...
                    case Constants_H.G_HCENTER_BOTTOM /* 33 */:
                        if (findItem(-2, id == 32 ? 33 : 32, true) > 0) {
                            ...
                            if ((rId == 34 && findItem(-2, rId, true) > 0) || rId == -1 || findItem(-2, rId, true) >= 99) {
                                rId = -1;
                            }
                            if (rId != -1) {
                                addItem(rId, 1);
    ...
    private void keyMY_BAG() throws IOException {
        if (!Ms.i().key_delay()) {
            if (this.popMenu == -1) {
    ...
    */
    private void drawNidus(int x, int w) throws IOException {
    ...
    private void keyNidus() throws IOException {
        if (!Ms.i().key_delay()) {
            if (this.mini_state == 16) {
                if (Ms.i().key_Up_Down()) {
    ...
    private void drawLIST_INFO() {
        ...
        int i = Constants_H.WIDTH_ - 12;
        Graphics graphics = g;
        Graphics graphics2 = g;
        uiI.drawString(str, i, 34, 8 | 16, 3, 1);
        ...
        Graphics graphics3 = g;
        Graphics graphics4 = g;
        uiI2.drawString(str2, Constants_H.WIDTH_H_, i2, 1 | 32, 3, 1);
        byte t = this.pkey.selectMenuX(5, 100, 0, Constants_H.WIDTH_ / 6, 35);
        if (t != -1) {
            this.cur_a = t;
            this.infoStart = (byte) 0;
            if (this.cur_a > 0) {
                for (byte i3 = 0; i3 < this.cur_a; i3 = (byte) (i3 + 1)) {
                    this.infoStart = (byte) (this.infoStart + this.monInfo_dir[i3].length);
                }
            }
        ...
        while (i4 < 5) {
            Ui uiI3 = Ui.i();
            byte b = this.cur_a == i4 ? (byte) 5 : (byte) 0;
            int i5 = Constants_H.WIDTH_ - 26;
            Graphics graphics5 = g;
            Graphics graphics6 = g;
            uiI3.drawUi(b + i4, (((i4 + 1) * 614) / 6) + 18, 12, 4 | 2, 0);
            i4 = (byte) (i4 + 1);
        }
    ...
    private void drawInfoList(int x, int y, int w, int sh, int show_num, int listMax, byte[] sel) {
        ...
        for (byte i2 = sel[1]; i2 < sel[1] + show_num && i2 < listMax; i2 = (byte) (i2 + 1)) {
            Ui uiI = Ui.i();
            int i3 = this.monInfoList[this.monInfo_dir[this.cur_a][i2]] == 2 ? 25 : 48;
            int i4 = ((i2 - sel[1]) * (sh + 4 + 2)) + y + 11;
            Graphics graphics = g;
            Graphics graphics2 = g;
            uiI.drawUi(i3, x - 10, i4, 8 | 16, 0);
            if (sel[0] == i2) {
                i = 0;
            } else {
            ...
            int i5 = (Constants_H.WIDTH - 25) - 15;
            int i6 = ((i2 - sel[1]) * (sh + 4 + 2)) + y + 5;
            Graphics graphics3 = g;
            Graphics graphics4 = g;
            uiI2.drawString(infoType, i5, i6, 8 | 16, color, 0);
    ...
    public void keyLIST_INFO() throws IOException {
        if (!Ms.i().key_delay()) {
            if (Ms.i().key_S1_Num5()) {
    ...
    private void goLIST_INFO(boolean bb) throws IOException {
        run_state = 68;
    ...
    private void goMONSTER_INFO(int id) throws IOException {
        run_state = 67;
    ...
    private void drawMONSTER_UI(Monster[] monsters) throws IOException {
        int offx = Constants_H.WIDTH_H_ - 140;
        Ui.i().fillRectB();
        Ui.i().drawK2(offx, 2, 280, Constants_H.HEIGHT_ - 2, 0);
        int lx = offx + 6;
    ...
    private void drawMonList(Monster[] monster, int x, int y, int show_num, int max_length, byte[] select) throws IOException {
        byte i = select[1];
    ...
    private void drawMagicUI(Monster monsters) {
        ...
        Ui uiI = Ui.i();
        int i2 = Constants_H.WIDTH_H_ - 25;
        int i3 = 108 + 1;
        Graphics graphics = g;
        Graphics graphics2 = g;
        uiI.drawString(Constants_H.PAUSE_TXT_12, i2, i3, 8 | 16, this.popMenu == 0 ? 0 : 1, 0);
        ...
        Ui uiI2 = Ui.i();
        int i4 = (267 + Constants_H.HEIGHT_H_) - 13;
        int i5 = 108 + 25 + 13;
        int i6 = (Constants_H.HEIGHT_ - 108) - 120;
        ...
        uiI2.sliding(i4, i5, i6, b2, b, true);
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public void drawEvolveUI(int mode, int id, boolean bb) throws IOException {
        Ui.i().fillRectB();
    ...
    private void key_MONSTER_LIST(Monster[] mon) throws IOException {
        if (this.popMenu == -1) {
    ...
    private void putMonster() throws IOException {
    ...
    private void setPutMonster() throws IOException {
    ...
    private void takenMonster() throws IOException {
    ...
    private void setTakenMonster() throws IOException {
    ...
    public void goVIEW_MONSTER() throws IOException {
        run_state = 35;
        this.cur_c = (byte) 0;
        this.selecty = (byte) 0;
        this.selectx = (byte) 0;
    ...
    public void key_gameRun() throws IllegalStateException, IOException, IllegalArgumentException {
        if (run_state == 98) {
    ...
    */
    ...
    private void paintBATTLE_OVER() throws IOException {
        if (this.b_c == 1) {
    ...
    private void useState(int type, int id) throws IOException {
        mc.paint();
    ...
    private void mpAdd(int hp) throws IOException {
    ...
    private void hpAdd(int hp, int offer) throws IOException {
    ...
    private void allAdd(int hp) throws IOException {
        boolean bmp = false;
        boolean bhp = false;
    ...
    private void changeEffect() throws IOException {
    ...
    private void resetMonster(int hp) throws IOException {
        if (this.myMonsters[this.select[0][0]].monsterPro[0] < 1) {
            AddMP((this.myMonsters[this.select[0][0]].monsterPro[3] * hp) / 100, this.myMonsters[this.select[0][0]]);
            AddHP((this.myMonsters[this.select[0][0]].monsterPro[2] * hp) / 100, this.myMonsters[this.select[0][0]]);
            this.myMonsters[this.select[0][0]].effect = (byte) 7;
    ...
    private void resetFealty(int hp) throws IOException {
        ...
        if (this.myMonsters[this.select[0][0]].monster[6] < fealty && this.myMonsters[this.select[0][0]].monsterPro[0] > 0) {
            if (hp == -1 || this.myMonsters[this.select[0][0]].monster[6] + hp > fealty) {
    ...
    private void setEnemyThrow() throws IOException {
        this.enemyOff = 63;
    ...
    private void setMyThrow() throws IOException {
    ...
    private void setThrow(Battle be, Monster mon, int mini) throws IOException {
    ...
    private void drawThrowBall(Battle be, Monster mon, int mini, int x, int y) {
        if (be.throw_state == 0) {
            ...
            int i = be.cThrow[0] + x;
            int i2 = y - be.cThrow[1];
            Graphics graphics = g;
            Graphics graphics2 = g;
            uiI.drawImage(image, i, i2, 1 | 32);
    ...
    */
    ...
    private void drawBattleBG() {
        ...
        uiI.drawImage(image, Player.REALIZED, 144, 0, DirectGraphics.FLIP_HORIZONTAL);
    ...
    private boolean changeMy() throws IOException {
    ...
    private void runBattleState() throws IOException {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private boolean runHitToState(Battle amB, Battle dmB, int mState) throws IOException {
    ...
    private void keyBattleState() throws IOException {
        if (!Ms.i().key_delay()) {
            switch (this.battle_state) {
                case 2:
                    if (Ms.i().key_Left_Right()) {
    ...
    */
    public boolean drawMagicC(int i, int skill_mode, int select, int x, int y, int dir) {
        ...
        int iAction = this.magic[skill_mode].action(select, this.now_action_Magic[i], 0);
        while (true) {
            short frame_id = (short) iAction;
            ...
            iAction = this.magic[skill_mode].action(select, this.now_action_Magic[i], 0);
        }
    }
    ...
    public void initMonStream(int type, int id, int i) throws IOException {
    ...
    public void initMonPro(int no, boolean mode) throws IOException {
        Ms.i();
        Ms.skip = 0;
    ...
    public void initBattle() throws IOException {
        System.gc();
    ...
    */
    ...
    public void skyCheckRegFull(int where) throws IOException {
        switch (where) {
            case 1:
