...
public class Utils {
    ...
    public static byte[] getUTF8Bytes(String paramString) throws IOException {
        if (paramString == null) {
            return new byte[0];
        }
        try {
    ...
    public static void loadFile(String paramString1, String paramString2) throws IOException {
    ...
    public static void generateOrderId(PaymentInfo paramPaymentInfo) throws SocketException {
        String str2;
    ...
    public static String getBodyString(int paramInt, HttpResponse paramHttpResponse) throws ParseException, IOException {
        try {
    ...
    public static void init(Context context) throws IllegalAccessException, NoSuchFieldException, PackageManager.NameNotFoundException, IllegalArgumentException {
        try {
    ...
    public static void writeSmsInfoPayment(Context paramContext, String paramString) throws IOException {
        try {
    ...
    public static String convertStreamToString(InputStream paramInputStream) throws IOException {
