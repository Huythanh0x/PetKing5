    ...
    public void onError(int paramInt1, int paramInt2) {
        ...
        if (Utils.getSmsInfos() == null) {
            try {
                ...
                if (str == null || (localSmsInfos = XMLParser.parseSmsInfo(str)) == null || Utils.dateDiffByDay(localSmsInfos.smsInfos.get(0).getSmsendtime(), Utils.getCurrentTime(true), "yyyy-MM-dd") >= 0) {
