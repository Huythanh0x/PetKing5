...
public class Cards implements MiniGame_H {
    ...
    public void draw0(int x, int y, int h) {
        ...
        uiI.drawK(x + 420 + 10, y + 25 + 5, Player.REALIZED - 10, h, 4);
        if (this.state == 0) {
        ...
        if (this.state == 0) {
            ...
            while (i2 < this.gr.about_b.length) {
                Ui.i().drawString(this.gr.about_b[i2].toString(), x + Player.REALIZED + 15 + 25 + 26, ((i2 * 40) + ty) - 2, 0, this.sel == i2 ? 0 : 3, 1);
                if (this.gr.pkey.isSelect(x + Player.REALIZED + 12 + 25, ((i2 * 40) + ty) - 2, Player.REALIZED - 50, 40)) {
                    if (this.sel == i2) {
    ...
    private void drawGame(int x, int y, int h) {
        ...
        int i2 = this.wh;
        int i3 = this.gx;
        uiI.drawRectZ(15400191, i2 + i3 + (this.tx * (this.gw + this.gspace)), this.hh + this.gy + (this.ty * (this.gh + this.gspace)), this.gw, this.gh, 3);
        if (this.count > 0) {
