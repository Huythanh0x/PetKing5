...
public class Guess implements MiniGame_H {
    ...
    private void draw() {
        ...
        uiI.drawK(10 + 420, 25 + 10, Player.REALIZED, h, 4);
        ...
        if (this.state == 0) {
            ...
            while (i2 < this.gr.about_b.length) {
                Ui.i().drawString(this.gr.about_b[i2].toString(), 10 + Player.REALIZED + 15 + 25 + 26, ((i2 * 40) + 105) - 2, 0, this.sel == i2 ? 0 : 3, 1);
                if (this.gr.pkey.isSelect(10 + Player.REALIZED + 12 + 25, ((i2 * 40) + 105) - 2, Player.REALIZED - 50, 40)) {
                    if (this.sel == i2) {
                        this.gr.pkey.setKey5();
                    } else {
                        this.sel = (byte) i2;
