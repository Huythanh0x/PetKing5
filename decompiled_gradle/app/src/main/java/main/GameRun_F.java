...
public class GameRun_F implements Key_H {
    ...
    //todo error array[][]
    public byte[][] selectBag = (byte[][]) Array.newInstance((Class<?>) Byte.TYPE, new int[]{4, 2});
    //todo error array[][]
    public byte[][] select = (byte[][]) Array.newInstance((Class<?>) Byte.TYPE, new int[]{2, 2});
    ...
    public void loadItem() {
        ...
        for (int i2 = 0; i2 < this.items.length; i2++) {
            //todo error array[][]
            this.items[i2] = (byte[][]) Array.newInstance((Class<?>) Byte.TYPE, new int[]{this.len[i2], 2});
            int j = 0;
